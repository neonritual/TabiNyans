...
from .views import AllHotels, HotelDetailView, AddReview, index, add_hotel, register_user, login_user, logout_user, AboutUs, search_hotels, admin_approval, hotel_approvals, approve_hotel, delete_hotel, review_approvals, approve_review, delete_review
...
urlpatterns = [
    ...
    path('approvals', admin_approval, name='approval'),
